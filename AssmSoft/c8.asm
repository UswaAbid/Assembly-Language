...
;Initialization
    ...
    mov cx , 10
    mov bx , 0          ;moving num1 value 011C to bx
      
  Outerloop:

    add  ax, [num1 + bx]   ;adding value(at address [011C], [011E],[0120],[0122] in reg [BX] ,that is representing an address now, with value at register AX)
